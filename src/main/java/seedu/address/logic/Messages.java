...
import static seedu.address.logic.parser.ArgumentTokenizer.MAX_FIELD_LENGTH;
...
public class Messages {
    ...
    public static final String MESSAGE_FIELD_TOO_LONG = "Field value exceeds maximum length of " + MAX_FIELD_LENGTH + " characters: ";
